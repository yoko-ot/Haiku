...
#                print(encoded_vectors.data)
                ...
                print("encoded_vectors type",type(encoded_vectors))
                print("encoded_vectors length",len(encoded_vectors))
                print("decoded_vector type",type(decoded_vector))
                print("decoded_vector length",len(decoded_vector))
